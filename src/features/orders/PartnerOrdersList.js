...
import { getOrders, getCount, getPartnerOrders } from './query';
      ...
      <Row>
        <Col>
          <ListTable
            ...
            query_key={"orders"}
            title={"Лист Заказов"}
            add_link={"/partner/orders/create"}
            edit_link={"/partner/orders/edit"}
            view_link={"/partner/orders/view"}
            query_filter={{ where: { partnerId: partner }, include: [{ category: ['rootCategory', 'parent'] }, 'transport', 'driver', 'creator'] }}
            filters={{
              field: 'status',
              data: [
...
PartnerOrdersList.propTypes = {};
PartnerOrdersList.defaultProps = {};

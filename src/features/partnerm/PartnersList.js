...
import { getPartnerms, getCount, delPartnerm } from './query';
...
export default function PartnersList() {
  return (
    <Row>
      <Col>
        <ListTable
          mut_delete_fn={delPartnerm}
          query_fn={getPartnerms}
          cnt_query_fn={getCount}
          query_key={"partners"}
          title={"Лист пользователей"}
          add_link={"/admin/partnerm/add"}
          edit_link={"/admin/partnerm/update"}
          view_link={"/admin/partnerm/view"}

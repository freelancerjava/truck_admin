...
import { getPartnerTransports, delTransport, getCount } from './query';
import { Link } from 'react-router-dom';
import ListTable from '../../extrafunc/Crud/ListTable';

export default function PartnerTransportsList() {
  return (
    <Row>
      <Col>
        <ListTable
          ...
          query_fn={getPartnerTransports}
          query_key={"transports"}
          title={"Лист транспортов"}
          add_link={"/partner/transports/add"}
          edit_link={"/partner/transports/update"}
          view_link={"/partner/transports/view"}
...
PartnerTransportsList.propTypes = {};
PartnerTransportsList.defaultProps = {};

...
const TransportRegister1FileUploader = ({ ...props }) => {
    ...
    return (
        <div className='d-flex align-items-center justify-content-space-between flex-column'>
            <label for='transport_register1'>
                <img src={props.input.value.transport_register1
                    && props.input.value.transport_register1.result
            ...
            <Input hidden type='file' onChange={onFileChange} id={'transport_register1'} />
...
TransportRegister1FileUploader.propTypes = {};

export default TransportRegister1FileUploader;
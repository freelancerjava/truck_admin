...
const SidebarParner = ({ bgColor, routes, logo, location, mini }) => {
    ...
    >
      <Container fluid>
        ...
        <Collapse navbar isOpen={collapseOpen}>
          ...
          <Nav navbar >
            {createLinks(routes, "/")}
            {createLinks(partnerorderroute, "/partner/")}
            {createLinks(partnerusersroute, "/partner/")}
            {createLinks(transportsroute, "/partner/")}
            {createLinks(notificationsroute, "/partner/")}
            {createLinks(transactionsroute, "/partner/")}
            {createLinks(chatsroute, "/partner/")}
...
SidebarParner.defaultProps = {
  routes: [{}],
};

export default SidebarParner;
